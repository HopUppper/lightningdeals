    ...
    <div className="container-tight relative z-10">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {reviews.map((r, i) => (
          ...
          >
            <Quote className="absolute top-5 right-5 w-7 h-7 text-primary/5 group-hover:text-primary/10 transition-colors duration-500" />
            ...
            <div className="flex items-center gap-3">
              <div
                className="w-10 h-10 rounded-full flex items-center justify-center text-primary-foreground font-display font-bold text-xs shrink-0"
        ...
        <div className="inline-flex items-center gap-3.5 px-6 py-3 rounded-full glass-card border border-border/30">
          <div className="flex -space-x-2">
            {reviews.map((r, i) => (
              <div
                key={r.initials}
                className="w-8 h-8 rounded-full border-2 border-background flex items-center justify-center text-primary-foreground font-display text-[9px] font-bold"
