        ...
        {steps.map((s, i) => (
          <motion.div key={s.step} variants={card} className="relative">
            ...
            <div className="glass-card p-10 text-center relative group h-full">
              <div className="absolute top-6 right-6 text-5xl font-display font-bold text-primary/5 select-none group-hover:text-primary/10 transition-colors duration-700">
                {s.step}
              </div>
              <div className="w-16 h-16 rounded-2xl bg-primary/8 flex items-center justify-center mx-auto mb-6 group-hover:bg-primary/15 group-hover:scale-110 transition-all duration-500">
